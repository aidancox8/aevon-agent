...
- **Email 2** (+5 days) — the demo link (clinic-scheduler-demo.web.app), framed as a version set up like a clinic, terms in one line, easy reply.
- **Email 3** (+5 days) — final "I'll leave it here."
